...
Parenting is also a lot of fun at the moment. I can set aside 15 hours a week at least for my coding, which is great! Consistency is key and I want to upload some code to my github repos at least once a day, to challenge myself and to stay at it. That is why I have also started a new sideproject, a personal art database, privelart. Another day [another github repo][ArtGit]! 

[ArtGit]: https://github.com/Febtwenty/privelart
[UniHell]: https://fullstackopen.com/en/
[Phonebook]: https://phonebook-wq80.onrender.com/